...
8. Produce `crm_setup_spec.md` and ask the user to review the human route before design.
9. Keep technical files as support evidence. The user should not need to read
