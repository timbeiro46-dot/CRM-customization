...
2. Explain current phase, completed evidence, blockers, strategic question, and next safe step in Spanish.
...
Do not surface YAML, JSON, manifests, or code modules unless the user asks for technical details.
